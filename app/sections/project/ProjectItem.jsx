...
export function ProjectItem({ project, index }) {
	...
	const galleryImages = images.map((img) => ({
		original: urlFor(img.asset).url(), // Assuming 'url' is the property that holds the image URL
		loading: "lazy"
	}));

	console.log("1", galleryImages);
